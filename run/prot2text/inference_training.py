...
from train import load_model, setup, cleanup
...
argParser.add_argument("--max_description_length", type=int, default=1021)
...
if __name__ == "__main__":
    ...
    parsed_args.root_dataset_dir = "data/csv"
    parsed_args.root_csv_dir = "data/csv"
    parsed_args.load_adapter_checkpoint_dir = "data/prot2text/checkpoints/checkpoints_260217_191145/adapter_checkpoint_5"
    parsed_args.save_generation_dir = "data/prot2text/generations/generations_260217_191145"
    parsed_args.torch_dtype = torch.bfloat16
    parsed_args.batch_size_per_device = 8
    parsed_args.generate_split = "test"
    parsed_args.max_generation_length = 1024
    parsed_args.num_beams = 4
